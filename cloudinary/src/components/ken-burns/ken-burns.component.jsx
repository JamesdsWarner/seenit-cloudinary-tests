...
import { upload, genDeliveryURL, createSlideshow } from "../../helpers";
...
import NewSlideShowPreviewer from "../NewSlideShowPreviewer";
...
const KenBurns = () => {
  ...
  const buildSlideShow = async () => {
    try {
      ...
      // const deliveryUrl = await createSlideshow(uploadedImgsPublicIds, duration);
